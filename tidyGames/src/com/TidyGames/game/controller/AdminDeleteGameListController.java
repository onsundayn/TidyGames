...
/**
 * Servlet implementation class AdminGameUploadController
 */
@WebServlet("/deletelist.ga")
public class AdminDeleteGameListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDeleteGameListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/game/adminDeleteGameList.jsp").forward(request, response);
