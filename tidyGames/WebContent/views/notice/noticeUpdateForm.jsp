            ...
            <form action="" id="enroll-form" method="post">
				...
				<table>
                    <tr>
                        ...
                        <td width="800" heigt="30" colspan="4"><input type="text" name="title" required value="원래있던제목있어야함"></td>
                    </tr>
                    <tr><td colspan="5" height="20"></td></tr>
                    <tr>
                        <td colspan="5" style="background:white">
                            <textarea rows="30" name="content" required style="resize:none">원래있던내용있어야함</textarea>
                        </td>
                    </tr>
                    <tr><td colspan="5" height="20"></td></tr>
                    <tr>
