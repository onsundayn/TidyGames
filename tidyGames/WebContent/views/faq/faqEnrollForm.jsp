...
<body style="background-color: #0e332c;">
    ...
    <div class="outer">
        ...
        <div class="write-form">
			<br><br>
            <form action="<%=request.getContextPath()%>/faqInsert.fa" method="post">
				<input type="hidden" name="userId" value="<%=loginUser.getMemId()%>">
				
                <table>
                    <tr>
                        <th width="70"><h5>제목</h5></th>
                        <td width="830" heigt="30"><input type="text" name="title" required style="width: 100%;"></td>
                    </tr>
                    <tr><td colspan="2" height="20"></td></tr>
                    <tr>
                        <td colspan="2" style="background:white;">
                            <textarea rows="20" name="content" required style="resize:none; width: 100%; "></textarea>
                        </td>
                    </tr>
                    <tr>
