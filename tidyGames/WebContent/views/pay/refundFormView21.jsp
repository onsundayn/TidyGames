        ...
        <div id="outer">
            ...
            <div class="area1">
                <div>
                        ...
                        <table class="table table-borderless" style="color:white; border:1px solid grey; background:rgba(0, 0, 0, 0.445);">
                            <thead>
                                <tr>
                ...
                <div class="resonse">
                    <form action="">
                        ...
                        <select name ="why" id="why">
                            ...
                            <input type="radio" name="payment" value="credit"> 예상했던게임과다름
